...
% \titlegraphic{\includegraphics[height=1cm,keepaspectratio]{figures/mpi_logo.png}\hfill
...
\begin{frame}
    \frametitle{Why should this fail again?}
    \begin{figure}
        \centering
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../figures/energetic_framework/R_TOA_flux.png}    
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../figures/energetic_framework/T_T0.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../figures/energetic_framework/T_anomaly.png}
    \end{figure}
\end{frame}
